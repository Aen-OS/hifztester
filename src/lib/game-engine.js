...
export function generateDistractors(correctVerse, difficulty, scopeVerses, surahVerses) {
...
export function buildQuestion(promptVerse, direction, difficulty, verseMap, scopeVerses, surahVerses) {
  const correctKey =
    direction === "next"
  ...
  const distractors = generateDistractors(correctAnswer, difficulty, scopeVerses, surahVerses);
